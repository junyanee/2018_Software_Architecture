...
public class Login extends UnicastRemoteObject implements RMILoginInterface {
	 ...
	 * @param sDataName
	 */
	public Login(String sLogicName, String sLogName) throws RemoteException, NotBoundException, MalformedURLException {
	...
	public static void main(String args[]) {
		...
		try {
			Login objLogin = new Login(LOGIC_NAME, LOG_NAME);
			// rmi에 "Login" name 등록
