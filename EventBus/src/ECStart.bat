...
START "STUDENT COMPONENT FUNCTION CONSOLE" /NORMAL java Components.Student.StudentsMain
%ECHO Starting Course Component Function Console
START "COURSE COMPONENT FUNCTION CONSOLE" /NORMAL java Components.Course.CoursesMain