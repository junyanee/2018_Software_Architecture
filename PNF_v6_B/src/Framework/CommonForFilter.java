...
public interface CommonForFilter extends Runnable{
    ...
    public void connectOutputTo(CommonForFilter filter, int outputPortNo) throws IOException;
    ...
    public void connectInputTo(CommonForFilter filter, int id) throws IOException;
